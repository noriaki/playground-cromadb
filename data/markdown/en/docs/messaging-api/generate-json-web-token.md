...
1. Execute the [Issue channel access token v2.1](../../../en/reference/messaging-api.md#issue-channel-access-token-v2-1) endpoint with the JWT you generated to issue a channel access token.
